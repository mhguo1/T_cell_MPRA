...
file_prefix="CMS_OL12"
file_date="20200827"
setwd(paste0(wd,"Tag_analysis_20200827/"))
dir.create("plots")
dir.create("results")

inputFullAttributesFileName=paste0(wd,"Tcell_GWAS_ctrl.attributes")

countsFileName=paste0(wd,"Tag_analysis_20191002/TGWAS_BC-Counts_20191002.out")
inputConditionsFileName=paste0(wd,"Tag_analysis_20191002/TGWAS_BC-Counts_20191002.cond")
...
CellSpecific_Ttest<-function(tmp_attributeData, counts, func_output, Ctrl.Mean, Exp.Mean, ctrl_cols, exp_cols) {
  ...
  is_OE <- out$A.logPadj_BH >= OE_threshold | out$B.logPadj_BH >= OE_threshold 
